...
<div class="ui-body">
    ...
    <span> <a href="/scraper/" class="ui-btn ui-btn-inline">Portal List</a>
        <a href="#" class="ui-btn ui-btn-inline">Add Portal</a> <a
        href="#" class="ui-btn ui-btn-inline">Scraper Logs</a>
    </span>
    ...
    <div>
            ...
            <span> <a href="#" class="ui-btn ui-btn-inline">Add Account</a>
            </span>
